...
def analyze_sim_consequences(request):
    if request.method == 'POST':
        ...
        projection_response = openai.ChatCompletion.create(
            ...
            messages=[
                {"role": "system",
                 "content": "You are an insurance actuary specializing in cybersecurity risks tasked with generating a 12-month cost projection."},
