# Generated by Django 4.2.2 on 2023-09-26 14:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='OTRisk.tblassettype')),
        ...
        migrations.CreateModel(
            name='MitreControlAssessment',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('effectiveness_percentage', models.DecimalField(decimal_places=0, max_digits=3, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
                ('weighting', models.IntegerField()),
                ('notes', models.TextField(blank=True, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('control', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='OTRisk.mitreicsmitigations')),
                ('cyberPHA', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='OTRisk.tblcyberphaheader')),
            ],
            options={
